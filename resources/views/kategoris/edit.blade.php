                ...
                <div class="p-6 md:p-8">
                    <form action="{{ route('kategori.update', $kategori->KategoriID) }}" method="POST" id="editForm" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="InstansiID" 
                                    id="InstansiID" 
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-150 ease-in-out @error('InstansiID') border-red-500 @enderror"
                                    required>
                                <option value="">Pilih Instansi</option>
                                @foreach($instansis as $instansi)
                                    <option value="{{ $instansi->InstansiID }}" {{ old('InstansiID', $kategori->InstansiID) == $instansi->InstansiID ? 'selected' : '' }}>
