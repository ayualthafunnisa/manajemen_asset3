...
<div id="sidebar-overlay"
     class="lg:hidden fixed inset-0 bg-black/60 backdrop-blur-sm z-30 hidden transition-opacity duration-300"
     onclick="closeSidebar()"></div>

<!-- Sidebar -->
<aside id="sidebar"
       class="fixed lg:sticky top-0 left-0 h-screen w-64 bg-white border-r border-neutral-100 shadow-xl z-40 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 flex flex-col overflow-hidden">

    {{-- ===== LOGO ===== --}}
    <div class="flex-shrink-0 px-5 py-5 border-b border-neutral-100">
        ...
        @foreach ($grouped as $groupLabel => $items)
            ...
            @foreach ($items as $item)
                ...
                <div class="relative group/blocked">
                    ...
                    <div class="pointer-events-none absolute left-full top-1/2 -translate-y-1/2 ml-2 z-50 opacity-0 group-hover/blocked:opacity-100 transition-opacity duration-150 w-52">
                        <div class="bg-neutral-800 text-white text-xs rounded-xl shadow-xl p-3">
                            ...
                            <p class="text-neutral-300">Lengkapi data instansi terlebih dahulu.</p>
        ...
        <div class="mx-3 mb-3 p-3 rounded-xl bg-orange-50 border border-orange-200">
            <div class="flex items-start gap-2">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-xs font-bold text-orange-800">Data instansi belum diisi</p>
                    <p class="text-[11px] text-orange-600 mt-0.5">Beberapa menu terkunci.</p>
                    <a href="{{ route('profile.index') }}" class="inline-flex items-center gap-1 mt-2 text-[11px] font-semibold text-orange-700 hover:underline">
                        Lengkapi sekarang →
                    </a>
                </div>
            </div>
