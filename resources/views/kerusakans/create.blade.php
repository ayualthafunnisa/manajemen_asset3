...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-white shadow-sm border border-gray-200 px-4 py-3 rounded-lg">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('kerusakan.index') }}" class="text-gray-600 hover:text-purple-600 transition duration-150">Kerusakan Aset</a>
        </li>
        <li class="breadcrumb-item active text-gray-800" aria-current="page">Tambah Laporan</li>
    </ol>
</nav>
@endsection
